document.addEventListener("DOMContentLoaded", () => {
  ...
  // Simulate real-time updates (e.g., fetching new messages, user activity)
  setInterval(() => {
    // Simulating other users typing notifications
    simulateTypingNotification("SomeUser");
  }, 5000);
  ...
  window.addEventListener("beforeunload", () => {
    try {
      ...
      const updatedUsers = onlineUsers.filter((user) => user !== username);
